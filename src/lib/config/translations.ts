...
export const turkishTranslations: Locale = {
  code: 'tr',
  name: 'Türkçe',
  translations: {
    zoom: {
      ...
      marquee: 'Alan Seçerek Yakınlaştır',
      automatic: 'Otomatik',
      level: 'Yakınlaştırma Düzeyi ({level}%)',
      inArea: 'Alanı Yakınlaştır',
      menu: 'Yakınlaştırma Menüsü',
    },
    pan: {
      toggle: 'El Aracını Aç/Kapat',
    },
    pointer: {
      toggle: 'İşaretçi Modunu Aç/Kapat',
    },
    capture: {
    ...
    page: {
      ...
      single: 'Tek Sayfa',
      twoOdd: 'Çift Sayfa (Tek)',
      twoEven: 'Çift Sayfa (Çift)',
      vertical: 'Dikey',
      horizontal: 'Yatay',
      spreadMode: 'Sayfa Görünümü',
      scrollLayout: 'Kaydırma Yerleşimi',
      rotation: 'Sayfa Döndürme',
    },
    rotate: {
      clockwise: 'Saat Yönünde Döndür',
      counterClockwise: 'Saat Yönünün Tersine Döndür',
    },
    mode: {
      view: 'Görüntüle',
    ...
    tabs: {
      overflowMenu: 'Diğer Sekmeler',
    },
    stamp: {
      title: 'Kaşeler',
      allStamps: 'Tüm Kaşeler',
      emptyState: 'Seçili kitaplıkta kaşe bulunamadı.',
    },
    signature: {
      title: 'İmzalar',
      createNew: 'Yeni İmza Oluştur',
      createNewWithInitials: 'İmza ve Paraf Oluştur',
      placeSignature: 'İmza',
      placeInitials: 'Paraf',
      remove: 'İmzayı kaldır',
      emptyState: 'Henüz imza yok. Başlamak için bir tane oluşturun.',
      create: {
        title: 'İmza Oluştur',
        draw: 'Çiz',
        type: 'Yaz',
        ...
        initialsLabel: 'Paraf',
        clear: 'Temizle',
        typePlaceholder: 'örn. Ahmet Yılmaz',
        initialsPlaceholder: 'örn. AY',
        uploadPlaceholder: 'Buraya bir görsel tıklayın veya sürükleyin',
        font: 'Yazı Tipi',
        color: 'Renk',
        cancel: 'İptal',
        save: 'Kaydet',
    ...
    form: {
      ...
      toggleFillMode: 'Doldurma Modunu Aç/Kapat',
    },
    annotation: {
      text: 'Metin Ekle',
      ...
      overflowTools: 'Diğer Araçlar',
      group: 'Grupla',
      ungroup: 'Grubu Çöz',
      addLink: 'Bağlantı Ekle',
      removeLink: 'Bağlantıyı Kaldır',
      deleteAllSelected: 'Tümünü Sil',
    },
    link: {
      title: 'Bağlantı Ekle',
      url: 'URL',
      page: 'Sayfa',
      enterUrl: 'URL girin',
      enterPage: 'Sayfa numarası girin',
      pageRange: 'Sayfa 1 - {totalPages}',
      link: 'Bağlantı',
    },
    redaction: {
      area: 'Alanı Karart',
    ...
    security: {
      protected: {
        title: 'Korumalı Belge',
        description: 'Bu belgenin izinleri kısıtlanmış. Bazı özellikler sınırlı olabilir.',
        viewPermissions: 'İzinleri Görüntüle',
      },
      viewPermissions: {
        title: 'Belge İzinleri',
        description: 'Bu belge korumalı. Tüm izinleri açmak için sahip şifresini girin.',
        restrictedActions: 'Belge İzinleri',
      },
      unlock: {
        label: 'Sahip Şifresi',
        placeholder: 'Sahip şifresini girin',
        button: 'Kilidi Aç',
        success: 'Tüm izinlerin kilidi başarıyla açıldı.',
        invalidPassword: 'Geçersiz sahip şifresi. Lütfen tekrar deneyin.',
        failed: 'İzinlerin kilidi açılamadı.',
      },
    },
    protect: {
      permissions: {
        print: 'Yazdır',
        printHighQuality: 'Yüksek Kaliteli Yazdırma',
        copy: 'İçeriği Kopyala',
        accessibility: 'Erişilebilirlik İçin Ayıkla',
        modify: 'İçeriği Değiştir',
        annotations: 'Açıklamaları Değiştir',
        fillForms: 'Formları Doldur',
        assemble: 'Belgeyi Birleştir',
      },
    },
    common: {
      close: 'Kapat',
