<script lang="ts">
  ...
  const handleClick = (pageIndex: number) => {
    ...
    // Büyük/sanallaştırılmış (virtualized) belgelerde uzak bir sayfaya tek
    // seferde atlamak yanlış konuma düşebiliyor — sanal öğeler yeniden
    // hesaplandıktan sonra bir kez daha düzeltiyoruz.
