...
class TeacherStoreSupabase {
	...
	/** Göster/Gizle aç-kapa — HERKESE açık (misafir/salt okunur dahil).
	 *  Amaç: yöneticinin hazırladığı gizli metin/gizli alanı herkese
	 *  sunabilmekti — sadece açıp/kapatabilir, ekleyip/taşıyıp/silemez
	 *  (bkz. canManage). Sunucu tarafında da (RPC: toggle_hidden_answer)
	 *  artık aynı şekilde herkese açık. */
	canToggle = $derived(true);
